<template>
    ...
    <div class="login-container">
        <div class="box">
            <h1 class="main-tag brand-font bigger-font">Dept Login</h1>
            <div class="input-group">
                ...
                <button @click="login_dept(userInfo)" class="btn text-white c2 login-button">Let me in</button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async login_dept(userInfo) {
            try {
                var x = await this.loginDept(userInfo);
            } catch (error) {
